...
# SECRET_KEY = os.environ.get('^0x7e513+25!$j^*hin^bcfmvgu#b$k@6wk$bo+_$1^*-j6!^*')  # Consider using your secret key
SECRET_KEY = '^0x7e513+25!$j^*hin^bcfmvgu#b$k@6wk$bo+_$1^*-j6!^*'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'dummy',#dbname
        'USER': 'root',
        'PASSWORD': 'password',#Enter the sql password here
        'HOST': 'localhost',
        'PORT': '3306',
    }
}
